...
void test_height_BT() {
    ...
    cout<<"height: "<<heightLocationA<<endl;
...
void test_noofnodes_BT() {
    ...
    BinaryTreeNode* rootLocationA = travelDesk.getLocation("LocationA")->getServicePtr("LocationB")->getBSTHead();
    cout<<rootLocationA->getTripNodePtr()->getPickUpLocation()<<endl;
...
void test_show_trips_by_time_destination() {
    ...
    cout<<"test show trips by dest"<<endl;
...
void test_successor_predecessor_BST() {
    ...
    cout<<"succ: "<<node_->getDepartureTime()<<endl;
...
void test_book_trip() {
    ...
    cout<<firstBooking->getBookedSeats()<<endl;
